...
export default function Settings({ dateFormat, onDateFormatChange }) {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <section className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <h3 className="font-bold text-gray-900">Urgency thresholds</h3>
        <p className="text-xs text-gray-500 mt-1">Set the number of days remaining that marks a milestone or component as urgent.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
          {[['Milestones', 'milestoneUrgentDays', 'milestoneVeryUrgentDays'], ['Components', 'componentUrgentDays', 'componentVeryUrgentDays']].map(([label, urgentKey, veryUrgentKey]) => (
